CREATE OR REPLACE TABLE
  mldatachallenge2020.processed_data.test_examples
  partition by RANGE_BUCKET(example_number,GENERATE_ARRAY(1,180000,500))
  AS
SELECT
...
FROM
  `mldatachallenge2020.input_data.test_dataset`